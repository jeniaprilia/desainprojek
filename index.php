	...
	<header id="mu-hero">
		<div class="container">
			<nav class="navbar navbar-expand-lg navbar-light mu-navbar">
				<!-- Text based logo -->
				<a class="navbar-brand mu-logo" href="index.html"><span>KangenNet</span></a>
				<!-- image based logo -->
			  ...
			  <div class="collapse navbar-collapse" id="navbarSupportedContent">
			    <ul class="navbar-nav mr-auto mu-navbar-nav">
			      ...
			      <li class="nav-item"><a href="harga.php">Harga Paket</a></li>
			
			     
			        <li class="nav-item"><a href="bantuan.php">Bantuan</a></li>
					 <li class="nav-item"><a href="tentang.php">Tentang Kami</a></li>
